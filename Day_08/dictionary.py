...
student = dict()
student.update({'first_name': 'Fauziyya', 'last_name': 'Sani','gender': 'female','age': 30,'marital_status': 'Married','skills':['MySQL','PowerBI','Python'], 'country':'Nigeria','city': 'Kano','address': 'Kano'})
